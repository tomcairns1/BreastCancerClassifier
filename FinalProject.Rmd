...
step(bc.reg, direction = 'backward')
```

Since there are more than two classes in this dataset I will use multinomial
logistic regression to select the features of most importance. 
